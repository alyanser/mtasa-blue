...
private:
    bool OnVersionTagClick(CGUIElement* pElement);
    bool OnVersionTagMouseEnter(CGUIElement* pElement);
    bool OnVersionTagMouseLeave(CGUIElement* pElement);
    void UpdateCursor();
